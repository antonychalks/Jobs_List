...
As a **planner** I can register new users so that they can log in and use the system.
...
As a **Planner** I can send emails to the customer to confirm.
...
These details were chosen as they are the details a planner might immediately require, without having to open the full page.
...
![Screenshot of the project board at the end of this phase of the project](static/media/README/story_board.jpg)
